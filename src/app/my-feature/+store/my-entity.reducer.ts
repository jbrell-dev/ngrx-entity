...
export interface MyEntitiesFeatureState extends EntityState<MyEntity> {
  isLoading: boolean;
...
export const initialState: MyEntitiesFeatureState = adapter.getInitialState({
  isLoading: false,
  searchResult: null,
  errorMessage: '',
});
...
export const reducer = createReducer(
  initialState,
  on(MyEntityActions.searchMyEntitiesSuccess, (state, action) =>
